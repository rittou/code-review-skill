...
- Do not assume the Codex thread cwd automatically follows the worktree. Treat the handoff as explicit: after `scripts/qa-env.sh up`, continue the review against the generated worktree path, not the original local checkout.
